...
// render connector branding (title/website) read these off the initialize
// handshake, as do the MCP registry/directories. An icon is intentionally not
// advertised yet (pending a final brand asset).
