...
// handshake. ChatGPT custom connectors ignore icons today, but Claude and the
// MCP registry/directories increasingly consume them.
...
export const SERVER_ICON_URL = "https://tinify.dev/mcp-icon.png";
